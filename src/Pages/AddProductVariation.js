...
const AddProductVariation = () => {
  ...
  useEffect(() => {
    fetch(`https://smartseosolution-f3192830bfae.herokuapp.com/product-variation/${id}`)
      .then((res) => res.json())
  ...
  const handleVariation = (event) => {
    ...
    const url = `https://smartseosolution-f3192830bfae.herokuapp.com/add-variation/${variation._id}`;
    fetch(url, {
      method: 'PUT',
      headers: {
