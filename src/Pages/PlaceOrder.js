...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://smartseosolution-f3192830bfae.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
      .then((info) => setCash(info));
  }, []);

  useEffect(() => {
    fetch(`https://smartseosolution-f3192830bfae.herokuapp.com/product/${id}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://smartseosolution-f3192830bfae.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://smartseosolution-f3192830bfae.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
