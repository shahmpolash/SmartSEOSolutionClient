          ...
          <div className="row">
            <div className="col-lg-6 col-sm-12">
              <div className="about-img">
                <img src='https://i.postimg.cc/TPgBGQDM/Add-a-subheading-1.png' alt />
              </div>
            </div>
            <div className="col-lg-6 col-sm-12 ptb-100">
              ...
              <div className="row">
                <div className="col-lg-12">
                  ...
                  <img className="icon-img" src='https://i.postimg.cc/YCzpSshg/facebook-1.png' alt />
                ...
                <div className="col-lg-12">
                  <div className="about-feature-blc">
                  <img className="icon-img" src='https://i.postimg.cc/c4VK32xb/google.png' alt />
                    <div className="about-feature-content">
                      <h6>Google Ads</h6>
